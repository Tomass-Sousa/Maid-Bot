...
const pings = new discord.MessageEmbed()
    ...
    .addField('Cliquez sur les réactions pour avoir les rôles {pings}, vous aurez une notification à chaque event proposé, jeux ou nouveauté.',':cherry_blossom: ⊱ Event \n :tanabata_tree: ⊱ Jeux \n :star2: ⊱ Nouveautés')
client.on('message', message => {
    if (!message.guild) return;
